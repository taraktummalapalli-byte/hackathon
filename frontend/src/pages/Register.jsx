...
import { Shield, Lock, Mail, ArrowRight, AlertCircle, Loader2, CheckCircle2 } from 'lucide-react';
        ...
        <div className="glass-card rounded-2xl p-8 border border-gray-800 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Start auditing your GitHub repositories & Zip codebases
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="py-2 space-y-1.5 text-xs text-gray-400">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-cyan-400" />
                <span>Instant automated security scan reports</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-cyan-400" />
                <span>Google Gemini AI vulnerability classification</span>
              </div>
            </div>
